...
class PreorderInvoice extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Флорбол. Предзаказ. Счёт на оплату № ' . $this->order->order_number,
        );
    }
    ...
    {
        $content = view('emails.orders.preorder', $this->content()->with)->render();
    ...
    protected function prepareData()
    {
        ...
        $isPreorder = $this->order->is_preorder;
