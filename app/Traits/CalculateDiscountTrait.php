...
Тестирование скидок:
    Написать юнит-тесты для проверки корректности применения скидок. Это поможет избежать ошибок при изменении логики.
...
Логирование и аналитика:
    Добавите логирование применённых скидок. Это поможет анализировать, какие скидки наиболее популярны и эффективны.
...
Гибкость системы:
    ...
    Если количество скидок станет большим, оптимизировать запросы к базе данных. Например, можно кэшировать скидки для часто запрашиваемых категорий или рангов пользователей.
*/

/*4. Групповые скидки
    Если захотим делать скидки на группы товаров (например, "купи 3 товара из категории X и получи скидку 10%"), можно добавить поддержку таких условий. 
