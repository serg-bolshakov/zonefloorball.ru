...
enum PaymentStatus: string {
    ...
    public function label(): string {
        return match($this) {
            ...
            self::INITIATED             => 'Операция оплаты инициализирована',  // деньги от покупателя не получены. Или от пользователя ещё не поступила оплата по выставленному ему счёту или платёжная система, через которую пользователь совершает оплату, ещё не подтвердила факт оплаты.
