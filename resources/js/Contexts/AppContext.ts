...
import { ICategoryInfoItem } from "./AppProvider";
...
export interface IAppContextType {
    ...
    categoriesInfo: ICategoryInfoItem[] | null;            // массив категорий. categoriesInfo может быть null или undefined (например, данные ещё не загружены), пропишем это в типе:
    ...
    setCategoriesInfo: (categoriesInfo: ICategoryInfoItem[] | null) => void;       // // setCategoriesInfo: Dispatch<SetStateAction<ICategoryInfoItem[]>>;
}
