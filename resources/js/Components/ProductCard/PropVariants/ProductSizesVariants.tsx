// resources/js/Components/ProductCard/PropVariants/ProductSizesVariants.tsx
...
const ProductSizesVariants: React.FC<Props> = ({ propVariants }) => {

    return (
        <section className="cardProduct-props__item">
            {/* Отличные модели мячей по цветам */}
            {propVariants.possibleProductSizesForProductCard && propVariants.possibleProductSizesForProductCard.length > 0 && (
                <div className="cardProduct-props__item">
                    <div className="cardStick-props__item-shaftLength-title fs12">
                        Размер:
                    </div>
                    
                    {propVariants.possibleProductSizesForProductCard.map(possibleSize => (
                        <motion.div 
...
export default ProductSizesVariants;