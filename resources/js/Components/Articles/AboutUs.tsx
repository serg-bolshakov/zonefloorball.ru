        ...
        <>
            ...
            <div className="footer-about__timeline-section">
                ...
                <div className="footer-about__timeline-item">
                    ...
                    <div className="footer-about__timeline-content text-align-left">
                        ...
                        <p>Наша команда - это сплав молодости и опыта, состоящая из Мастеров спорта Советского Союза и России.</p>
                        <p>Мы создаём продукцию со знанием дела и отвечаем за свои слова делом.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="foundation-section">
                <div className="foundation-card">
                    <h3 className="margin-bottom8px">Ассистент капитана команды "Алетерс"</h3>
                    <p className="margin-bottom8px">ИП Большаков Сергей Николаевич</p>
