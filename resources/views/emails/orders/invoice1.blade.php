...
table { width: 100%; margin: 0 auto 20px auto; border: 1px solid #dddddd; border-collapse: collapse; }
...
<ul>
<a href="{{ $pdfUrl }}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 10px 0; cursor: pointer;">Распечатать счёт</a>    
...
<h1>Счёт № {{ $orderNum }} от {{ $orderDate }}</h1>
<hr>
<h4>Поставщик:</h4>
...
<tr><td colspan="5" style="text-align: right; border-bottom: none !important; border-left: none !important;"><strong>Стоимость доставки/получения заказа:</strong></td><td style="text-align: right;">{!! $deliveryCost !!}</td><td></td></tr> 
<tr><td colspan="5" style="text-align: right; border-bottom: none !important; border-left: none !important;"><strong>Итого:</strong></td><td style="text-align: right;">{!! $totalOrderAmount !!}</td><td style="text-align: right;"><font color="red">{!! $totalDiscount !!}&nbsp;<sup>&#8381;</sup></font></td></tr>
<tr><td colspan="5" style="text-align: right; border-bottom: none !important; border-left: none !important;"><strong>Без налога (НДС)</strong></td><td></td><td></td></tr>
<tr><td colspan="5" style="text-align: right; border-bottom: none !important; border-left: none !important;"><strong>Всего к оплате</strong></td><td style="text-align: right;">{!! $totalOrderAmount !!}</td><td></td></tr>
</tbody>
</table>
